  ...
  const handleGenerate = async () => {
    ...
    const runGeneration = async () => {
      try {
        ...
        console.warn("Gemini TTS failed, attempting English Web Speech fallback...", err);
        ...
        try {
          ...
          const fallbackResult: AudioResult = {
            ...
            isFallback: true // Tag it as fallback for UI if needed
          };
          ...
          // Speak using native API (English)
          await webSpeechService.speak(text, { ...config, voiceId: 'en-US' });
        } catch (fallbackErr) {
