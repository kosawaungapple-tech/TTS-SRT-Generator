...
export class GeminiTTSService {
            ...
            if (status === 429) {
              ...
              if (waitSeconds > 0) {
                ...
                if (onRetry) {
                  ...
                  onRetry(waitInt, `API limit ထိနေသည်၊ ${waitInt} seconds နောက် ပြန်ကြိုးစားမည်...`);
                }
              } else {
  ...
  async generateTTS(
    ...
    const DELAY_BETWEEN_CHUNKS = 15000; // Increased to 15s for safer 10 RPM (4 chunks/min)
